...
# 出包（Python 版：build.sh 依赖 dirname/npm/sed，在本机 Git Bash 下会随机失败）
python deploy/script/build_fpk.py 0.2.0                    # 默认 x86 包（platform 由 goarch 推导）
