...
CASES = {
    ...
    ("test_inventory_flow", "test_asset_snapshot_change_flow"): dict(
    ...
    ("test_offline_flow", "test_offline_detection_and_recovery"): dict(
...
def get(module: str, name: str) -> dict:
    ...
    if meta is None:
        return dict(id="TC-UNREG-000", pre=P_SERVER,
